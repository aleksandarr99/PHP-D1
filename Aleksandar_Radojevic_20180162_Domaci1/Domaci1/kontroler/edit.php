...
<body style="background-color:#ffd180;">
    <div class="container p-4">
        <div class="row">
            <div class="col-md-4 mx-auto">
                <div class="card card-body" style=" background-color: #f9842c; color:whitesmoke;border-radius: 0.8rem; padding:1.5rem">
                    <form action="edit.php" method="POST">
                            <input name="id" type="hidden" value="<?php echo $oglasId ?>">
